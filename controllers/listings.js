...
// Lazy initialization of geocoding client
...
const listingController = {
    ...
    updateListing: async (req, res) => {
        ...
        // 1️⃣ Handle location separately before setting other fields
        if (req.body.listing.location) {
            try {
                ...
                // Now update the location string
